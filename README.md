...
| ⛔ | Estado real **de la credencial**: si el titular llegó a aceptar la oferta. Eso te-api no lo cuenta, así que la ficha dice «ofrecida» —lo que hizo el banco, que es lo único que sabe de sus propios actos— y **no pinta ninguna insignia** de «credencial activa». El **vínculo** sí se puede leer, y es la excepción a esta fila: `GET /v1/b2b/links` contesta si esta persona tiene cartera vinculada, y de ahí sale que el botón de avisar al móvil se deshabilite. Lo que sigue sin saberse es lo demás —si está suspendido, si retiró la cartera, si tiene aparato elegible— |
